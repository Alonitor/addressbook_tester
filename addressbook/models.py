...
class Contact(models.Model):
    group = models.ForeignKey(ContactGroup, related_name='contacts', on_delete=models.CASCADE)
...
class Website(models.Model):
    contact = models.ForeignKey(Contact, related_name='websites', on_delete=models.CASCADE)

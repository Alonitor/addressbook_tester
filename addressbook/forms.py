...
class ContactForm(ModelForm):
    ...
    class Meta:
        model = Contact
        fields = ('last_name',)  #TODO: OH Kanskje feil?
...
ContactFormSet = inlineformset_factory(ContactGroup, Contact, max_num=4, extra=1, can_delete=False, fields=('last_name',))
EmailEditFormSet = inlineformset_factory(Contact, Email, extra=1, formset=MandatoryInlineFormSet, fields=('email',))
PhoneEditFormSet = inlineformset_factory(Contact, PhoneNumber, extra=1, can_delete=True, fields=('phone',))
AddressEditFormSet = inlineformset_factory(Contact, Address, extra=1, formset=MandatoryInlineFormSet, fields=('street',))
WebsiteEditFormSet = inlineformset_factory(Contact, Website, extra=1, can_delete=True, fields=('website',))
SocialNetworkEditFormSet = inlineformset_factory(Contact, SocialNetwork, extra=1, can_delete=True, fields=('handle',))
